...
Purpose: Fail if a `release/X.Y.Z`, `release/X.Y.Z-rcN`, or `release/X.Y.Z-rc.N` branch already has a tag.
...
Notes:
- The guard expects branch naming `release/X.Y.Z`, `release/X.Y.Z-rcN`, or `release/X.Y.Z-rc.N`.
